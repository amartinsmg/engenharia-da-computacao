...
Adiconar o prefixo `unsigned` antes dos tipos inteieros (e de *char*) permite sobrar o limite máximo positivo da variável, mas remove sua capacidade de guardar valores negativos.
